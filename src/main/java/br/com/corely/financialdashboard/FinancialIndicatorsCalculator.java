...
public class FinancialIndicatorsCalculator {
    ...
    private final FinancialDashboardPaymentRepository paymentRepository;

    @Transactional(readOnly = true)
    public FinancialIndicatorsResponse calculate(String referenceMonth) {
        long totalInvoices = invoiceRepository.countInvoicesForMonth(referenceMonth);
        long overdueInvoices = invoiceRepository.countOverdueForMonth(referenceMonth);
        ...
        Object[] paymentData = paymentRepository.countAndSumPayments(monthStart, monthEnd);
        ...
        BigDecimal totalInvoiced = invoiceRepository.totalInvoicedForMonth(referenceMonth);
    ...
    private Object[] calculateStatusPercentages(String referenceMonth, BigDecimal totalInvoiced) {
        ...
        var statusData = invoiceRepository.countAndSumInvoicesByStatusForMonth(referenceMonth);
