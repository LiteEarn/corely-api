...
public class RevenueSummaryIndicator {
    ...
    public RevenueSummaryResponse calculate(String referenceMonth) {
        List<Object[]> statusData = invoiceRepository.countAndSumInvoicesByStatusForMonth(referenceMonth);
        ...
        Long totalInvoiceCount = invoiceRepository.countInvoicesForMonth(referenceMonth);
