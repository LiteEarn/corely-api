...
class TenantContextTest {
    ...
    @Test
    void getCurrentUserId_shouldReturnUserIdFromAuthenticatedUser() {
        UUID expectedUserId = UUID.randomUUID();
        when(authenticationFacade.getCurrentUserId()).thenReturn(expectedUserId);

        UUID result = tenantContext.getCurrentUserId();
    ...
    void getCurrentStudioId_shouldNeverAcceptStudioIdFromParameter() {
        var methods = TenantContext.class.getDeclaredMethods();
        assertThat(methods)
